const gened = [
  {
    id: 1,
    question:
      "Rennie Boy believes that everything that happens in this world has a cause or a reason. What scientific attitude is seen in his actions?",
    answers: [
      { text: "Curiosity", correct: false },
      { text: "Firm set of beliefs", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "Primaries", correct: false },
      { text: "Secondaries", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "√5 is a rational number.", correct: false },
      { text: "0 is a positive number", correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Hammers, wrenches, and screwdrivers", correct: true },
      { text: "Hammers, wrenches and screwdrivers", correct: false },
      { text: "Hammers wrenches, and screwdrivers", correct: false },
    ],
  },
  {
    ...
    answers: [
      { text: "Reputable", correct: false },
      { text: "Honorable", correct: false },
  ...
  },
  {
    id: 18,
    question:
      "Ibigay ang tayutay na nagamit sa sumusunod: Ikaw ang payong ng aking buhay - silungan ng init - hatid ay proteksyon sa panahong masungit",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Declared an open house", correct: false },
      { text: "Declared dividends", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Appreciating", correct: false },
      { text: "Emulating", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "Cope in", correct: false },
      { text: "Cope up", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "People smoking", correct: false },
      { text: "To people smoke", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "June 19, 1862", correct: false },
      { text: "June 19, 1858", correct: false },
  ...
  },
  {
    id: 35,
    question:
      "Given the following scores of 70, 95, 60, 80, and 100, what can you infer from the measures of variability that can be obtained from this?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "The file size is smaller.", correct: true },
  ...
  },
  {
    id: 38,
    question:
      "1/5 of the width and 1/4 of the length of a rectangular cardboard is cut off. What part of the original cardboard is the area of the remaining piece?",
    answers: [
      { text: "30% of the original area", correct: false },
      { text: "40% of the original area", correct: false },
  ...
  },
  {
    id: 42,
    question:
      "'Mahal kita, mahal kita, hindi 'to bola / Ngumiti ka man lang sana ako'y nasa langit na.' Ang salitang pampanitikan na ginamit sa linya ng kanta ay nangangahulugang _____.",
    answers: [
      { text: "Napakasaya", correct: true },
      { text: "Pakikipagkaibigan", correct: false },
  ...
  },
  {
    id: 43,
    question:
      "Which is the method of growing vegetables and low plants in a nutrient-packed aerated solution with no soil at all?",
    answers: [
      { text: "Vegetative cultivation", correct: false },
      { text: "Natural farming", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "II, III, and IV", correct: true },
      { text: "I, II, and IV", correct: false },
  ...
  },
  {
    id: 46,
    question:
      "You are a member of a cooperative which operates taxis, tricycles, and buses. Of which type of a cooperative are you a member?",
    answers: [
      { text: "Service cooperative", correct: true },
      { text: "Multipurpose cooperative", correct: false },
  ...
  },
  {
    id: 48,
    question:
      "Adolfo does not allow his feelings and biases to influence his recording of observations, interpretation of data, and formulation of conclusions. What scientific attitude is reflected in his actions?",
    answers: [
      { text: "Absence of bias", correct: false },
      { text: "Concern for the environment", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Tay", correct: false },
      { text: "Tayka", correct: true },
  ...
  },
  {
    id: 61,
    question:
      "What law was passed by Philippine Congress in 1995 which affirms the total integration of persons with disabilities into the mainstream of society?",
    answers: [
      { text: "R.A. 7277", correct: true },
      { text: "R.A. 7784", correct: false },
  ...
  },
  {
    id: 62,
    question:
      "Far _____ Terry’s small plane lay the freezing waters of the North Sea, where his father’s boat had disappeared many years before.",
    answers: [
  ...
  {
    id: 65,
    question: "Kailan natin ipinadiriwang ang Linggo ng Wika?",
    answers: [
      { text: "Hunyo 13-19", correct: false },
      { text: "Agosto 13-19", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "Have you", correct: false },
      { text: "Have you got", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "The supplement of an angle is acute.", correct: false },
      { text: "The complement of an angle is obtuse.", correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Electoral Tribunal", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "Dicidous forest", correct: false },
  ...
  },
  {
    id: 75,
    question:
      "What type of thermo-nuclear reaction occurs in the sun which generates a tremendous amount of heat energy?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Yoyong", correct: false },
      { text: "Kamay", correct: true },
  ...
  },
  {
    id: 81,
    question:
      "When a person shows the ability to understand and appreciate the similarities and differences in the customs, values, and beliefs of one's culture, that person is said to _____.",
    answers: [
      { text: "Possess multicultural literacy", correct: true },
      { text: "Possess sociocultural awareness", correct: false },
  ...
  },
  {
    id: 82,
    question:
      "Mr. Lucido deposited 225 pesos in the bank. If his deposit consisted of 29 bills, consisting of 5 peso, and 10 peso bills, how many 10 peso bills did he deposit?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Inumin", correct: false },
      { text: "Inuman", correct: true },
  ...
  },
  {
    id: 84,
    question:
      "When you carry a heavy load with one arm, you tend to hold your free hand away from your body in order to _____.",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Ma-galis", correct: false },
      { text: "Mag-alis", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Reclusion perpetua", correct: false },
      { text: "Res ipsa loquitur", correct: false },
  ...
  },
  {
    id: 93,
    question:
      "The elevator can carry a maximum load of 605 kg. How many passengers of weight 50.5 kg each can the elevator hold?",
    answers: [
      { text: "12", correct: false },
      { text: "11.9", correct: false },
  ...
  },
  {
    id: 96,
    question:
      '"Ang babae ay huwag mong tingnang isang bagay na libangan lamang kundi isang katuwang at karamay sa mga kahirapan nitong kabuhayan." (E. Jacinto) Ang tungkulin ng wika sa linya ay _____.',
    answers: [
      { text: "Pangheuristiko", correct: false },
      { text: "Pang-interaksyunal", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "30°, 60°, 90°", correct: false },
      { text: "45°, 45°, 90°", correct: false },
  ...
  },
  {
    id: 105,
    question:
      "The ratio of the number of red, green, and blue balls in a box is 2:5:6. How many green balls are there if there are 52 balls in all?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "Good teachers possess a capacity for cooperation; not in the method but in their hearts where they knowledge, spirit and emotion converge.",
        correct: false,
      },
      {
        text: "Good teachers are capable to promote interrelationship among learners, parents, school heads, and community.",
        correct: false,
      },
      {
        text: "Good teachers have the capacity to develop interpersonal relationship among the factors in the learning environment.",
        correct: false,
      },
    ],
  },
  {
    ...
    answers: [
      { text: "Will have started", correct: true },
  ...
  },
  {
    id: 108,
    question:
      "One of the objectives of Philippine Education as provided in the 1987 Constitution is to promote respect for human rights. To give flesh to this constitutional mandate, President Aquino issued an order requiring human rights to be integrated into the school curricula. Which of the following specifies the said directives?",
    answers: [
      { text: "DECS Order No. 61", correct: false },
      { text: "Executive Order No. 27", correct: true },
  ...
  {
    id: 109,
    question: "In which part of the flower do seeds develop?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "A good weather", correct: false },
  ...
  },
  {
    id: 115,
    question:
      "When two missing digits in a given number are replaced, the number is divisible by 99. What is the number?",
    answers: [
      { text: "85021", correct: false },
      { text: "85031", correct: false },
  ...
  },
  {
    id: 117,
    question:
      "Ibigay ang tayutay na nagamit sa sumusunod: Ilaw ng tahanan - Ikaw ang sandigan - Lamyos ng pagmamahal - Sa pag-unlad ko'y tangan.",
    answers: [
      { text: "Metonimiya", correct: true },
      { text: "Sinekdote", correct: false },
  ...
  },
  {
    id: 118,
    question:
      "A secret word that must be entered into the computer before a person is allowed access to information is called _____.",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "I might go", correct: true },
      { text: "I might to go", correct: false },
  ...
  },
  {
    id: 123,
    question:
      "What type of cooperative provides assistance to the general public such as transportation, health, and housing?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "You hurry", correct: false },
      { text: "Be hurrying", correct: false },
  ...
  {
    id: 126,
    question: "Which of the following demonstrates sublimation?",
    answers: [
      { text: "Dry ice evaporating", correct: false },
      { text: "Perspiration drying", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Kalan", correct: false },
      { text: "Kanlong", correct: false },
  ...
  },
  {
    id: 128,
    question:
      "A teacher wants to group her pupils into groups of 3, 5, or 6. However, she found out that if she does that, there will always be 1 pupil left. What is the least possible number of pupils in the class?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Pawatas", correct: true },
      { text: "Kontemplatibo", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "1½ times heavier", correct: false },
      { text: "½ as heavy", correct: false },
  ...
  },
  {
    id: 141,
    question:
      "Excursions are encouraged to allow participants to see places. All the 400 personnel fell ill. Doctors’ laboratory findings traced the cause to _____?",
    answers: [
      { text: "Congestion on the bus", correct: false },
      { text: "Food poisoning", correct: true },
  ...
  },
  {
    id: 143,
    question:
      "In a university, the ratio of female professors to the male professors is 8:5. If there are 75 male professors, how many are female professors?",
    answers: [
  ...
  {
    id: 144,
    question: "He _____ his leg while he _____ rugby.",
    answers: [
      { text: "Was breaking - played", correct: false },
  ...
  },
  {
    id: 147,
    question:
      "'Heto na, heto na, heto na, /wahh! Doo bidoo bidoo, bidoo, bidoo.' Alin ang nabuong salita o tunog sa linya na nabuo ayon sa teoryang pooh-pooh?",
    answers: [
      { text: "Wahh", correct: true },
  ...
  },
  {
    id: 153,
    question:
      "Imprisoned for 27 years, Nelson Mandela realized his dream of a free and non-racial South Africa by forgiving his oppressors and negotiating in good faith for the peaceful transition to democracy. Nelson Mandela demonstrated his trait of ________________.",
    answers: [
      { text: "Friendliness", correct: false },
      { text: "Determination", correct: false },
  ...
  },
  {
    id: 154,
    question:
      "In William Shakespeare’s 'Merchant of Venice,' Portia, the judge said: 'The quality of mercy is not strained; it droppeth as the gentle rain from heaven upon the place beneath... It is twice blest; it blesseth him that gives and him that takes. ‘Tis mightier than the mightiest... and one is likened to God when mercy seasons justice.' The main thought of the excerpt is that ___________________",
    answers: [
  ...
  },
  {
    id: 157,
    question:
      "Among models of reading strategies, what did student Jk adopt when she reads back and forth, attending to both what is in her mind and what’s on the page?",
    answers: [
      { text: "Bottoms-up", correct: false },
  ...
  },
  {
    id: 159,
    question:
      "When the USA decided to drop the atomic bomb on Nagasaki in order to stop the land invasion of Japan, what degree of moral certitude can describe this decision of the USA?",
    answers: [
  ...
  },
  {
    id: 160,
    question:
      "Isang dulog pampanitikan na kung saan ang pagpapakahulugan sa isang tekstong binasa ay nakapokus sa sariling panlasa ng mambabasa at kilala rin sa katawagan na reader-response theory.",
    answers: [
      { text: "Impresyonista", correct: true },
      { text: "Patalambuhay", correct: false },
  ...
  {
    id: 161,
    question: "I can’t find ________ calculator; may I use ________, Prince?",
    answers: [
      { text: "My, yours", correct: true },
      { text: "His, yours", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Joey Lina", correct: false },
      { text: "Jovito Salonga", correct: false },
  ...
  },
  {
    id: 169,
    question:
      "An ant colony stores food in the summer, defends itself by stinging enemies, and invades a competing ant colony. What is the term to best describe how this species copes with everyday life?",
    answers: [
      { text: "Ecological defeat", correct: false },
      { text: "Ecological success", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Rice terraces", correct: true },
      { text: "Mount Makiling", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Father Jacinto Zamora", correct: false },
      { text: "Father Pedro Pelaez", correct: true },
  ...
  },
  {
    id: 176,
    question:
      "Analects, which are short and witty sayings that treat of moral values and good human relations, are attributed to:",
    answers: [
      { text: "Mao Tze Tung", correct: false },
  ...
  {
    id: 178,
    question: "The acronym HTML means Hyper Text Markup ____________.",
    answers: [
  ...
  {
    id: 179,
    question: "The fraction halfway between 3/7 and 4/7 is ____________.",
    answers: [
      { text: "1/2", correct: true },
      { text: "1/3", correct: false },
      { text: "1/4", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Ramon Blanco", correct: false },
      { text: "Basilio Agustin", correct: false },
  ...
  },
  {
    id: 190,
    question:
      "How many glasses of Cola each to be filled with 150 cu cm of the liquid can be made from 5 family-size bottles of cola each containing 1.5 liters?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Dalhin", correct: false },
      { text: "Dalahin", correct: false },
  ...
  },
  {
    id: 197,
    question:
      "________ sa batas, hindi maaaring isakdal ng dalawang beses ang isang akusado para sa iisang pagkakasala.",
    answers: [
      { text: "Maliban", correct: false },
      { text: "Ayon", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "nasa bingit ng kamatayan", correct: true },
      { text: "namatay", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "maramihan : gaa-gaano", correct: true },
      { text: "maramihan : gaanuano", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "namasyal", correct: false },
      { text: "nagkalat", correct: true },
  ...
  },
  {
    ...
    answers: [
      { text: "Aurelio Tolentino", correct: false },
      { text: "N.V.M Gonzalez", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Indarapatra at Sulayman", correct: false },
